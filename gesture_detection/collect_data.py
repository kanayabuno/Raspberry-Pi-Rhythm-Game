...
while True:
    ...
    while True:
        ...
        if GYRx <= -10000 or GYRx >= 10000 :   #rotation
            newline = newline + "2,"
        else:
            if (GYRx > -10000 and GYRx <= -5000) or (GYRx < 10000 and GYRx >= 5000): #trying rotation but too slow
                newline = newline + "4,"
            else:
                if (GYRz <= -2500 or GYRz >= 2500): # CHOP
                    newline = newline + "1,"
                elif ((GYRz > -2500 and GYRz <= -1500) or (GYRz < 2500 and GYRz >= 1500)):  #trying stab but too slow
                    newline = newline + "3,"
                    
                else:
                    newline = newline + "-100,"

        #newline = newline + "{0:.2f}".format(AccXangle) + "," + "{0:.2f}".format(AccYangle) + "," + "{0:.2f}".format(GYRx) + "," + "{0:.2f}".format(GYRy) + "," + "{0:.2f}".format(GYRz)
